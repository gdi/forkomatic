...
== Synopsis
  class YourForkomaticClass < Forkomatic
    class YourForkomaticClass::Job < Forkomatic::Job
      attr_accessor :data
...
* Override the Forkomatic::Job initialize function to give your child processes data to work with.
* Override the Forkomatic::Job work! function to do whatever processing is required.
* Override the build_jobs() function to create 'count' child processes as needed.
